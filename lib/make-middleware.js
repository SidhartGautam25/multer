...
function makeMiddleware(setup) {
  console.log("inside makeMiddleware method");
  console.log("only agr in this method is a setup method");
  // again makeMiddleware is  returning a middleware
  // as it has req,res and next object
  return function multerMiddleware(req, res, next) {
    console.log(
      "this is the method which express run when a request of upload route come"
    );
    ...
    busboy.on(
      ...
      function (fieldname, fileStream, filename, encoding, mimetype) {
        ...
        fileFilter(req, file, function (err, includeFile) {
          console.log("i am the callback function of fileFilter");
          console.log("err is null ", err);
          console.log("includeFile is true ", includeFile);
          if (err) {
          ...
          storage._handleFile(req, file, function (err, info) {
            console.log("I am handleFile callback function");
            ...
            console.log("fileInfo looks like this ", fileInfo);
            console.log("calling replacePlaceholder");
            appender.replacePlaceholder(placeholder, fileInfo);

            uploadedFiles.push(fileInfo);
            console.log("uploadedFiles look like this ", uploadedFiles);
            pendingWrites.decrement();
            console.log("calling indicateDone ");
            indicateDone();
          });
        });
      }
